...
> **Current release:** `0.7.2` — adds evidence-driven diagnostics, before/after comparison, privacy-conscious upstream issue drafts, and Lua 5.1 regression validation.
